<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="wsapplicationareasearch.aspx.vb" Inherits="RexairWebSecurity.wsapplicationareasearch" EnableSessionState = "True"%>

<!DOCTYPE html >

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>WS Application Area Search</title>
...
<body class="font8veranda" oncontextmenu="return false">
  ...
  <form runat="server" id="wsapplicationmastersearch">
     <div id="container">
          <div class="row">
               <div class="column left" > <h1>Application Area Search</h1>
               </div>
   ...
   <hr class="hrheight2"/>
     ...
     <table style="width:60%;" class="font8veranda">
             ...
             <tr>
  			  <td>
                <strong>Area ID: </strong><input type="text" id="getareaid" value="" runat="server" maxlength="50"  tabindex="2" />
              </td>
			  <td>
          ...
          <ASP:GridView id="MyGridView" runat="server"
            ...
            <EmptyDataTemplate>
               <asp:Label ID="Label2" runat="server">
                   There is no data to display in this view. Get a valid Application ID and Area ID.
               </asp:Label>
            </EmptyDataTemplate>
			...
			<Columns>
               ...
               <asp:BoundField HeaderText="Area ID" DataField="area_id" ReadOnly="true" ItemStyle-Width="400px"/>
